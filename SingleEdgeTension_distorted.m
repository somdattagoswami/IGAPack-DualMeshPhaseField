...
[EPHTelem,PhPHTelem,EcontrolPts,PhcontrolPts,EmeshInfo,PhmeshInfo] = modelDualMesh(geometry,'singleEdgeTension_distort');
...
plotFD(file_name)
saveas(gcf,'ForceDisp_TensionDistort.png')