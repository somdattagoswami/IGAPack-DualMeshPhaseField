function [geometry, Mater, Fract, Integ] = Input_cube
...
geometry.patchBoundaries = {1,2,2,4;2,3,6,5;3,4,4,2};
...
geometry.W = 0.2; % Width of the plate in the V direction
...
% Material properties
Mater = struct;
%Mater.E = 21e5; % Young's Modulus based on (N/m2)
Mater.E = 210*1e3; % Young's Modulus based on (N/mm2)
...
Fract.constl = 1/32; % L0 : Length parameter which controls the spread of the damage
...
Integ.dfacto1 = 5e-4; % Displacement increment per time steps
Integ.dfacto2 = 5e-5; % Displacement increment per time steps
Integ.numStepsLimit = 14;
