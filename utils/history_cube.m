function [fenerg] = history_cube(Basis,Fract,PHTelem,geometry)
        ...
        if isempty(PHTelem{indexPatch}(i).children)            
            ...
            for ii = 1:nGaussX
                for jj = 1:nGaussY
                    for kk = 1:nGaussZ
                        kgauss = kgauss + 1;                        
                        dis = sqrt((Basis.gaussCord{indexPatch}{i}(1,kgauss)-0.5)^2+(Basis.gaussCord{indexPatch}{i}(3,kgauss)-0.5)^2);
