function [PHTelem,controlPts,dimBasis,fieldData,numberElements,markRef] = refineElemProjGraded3D(elemRef,PHTelem,controlPts,geometry,dimBasis,fieldData,numberElements)
