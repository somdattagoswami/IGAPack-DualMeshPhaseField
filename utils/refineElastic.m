function [EPHTelem,EcontrolPts,EmeshInfo,EmarkRef] = refineElastic(quadRef,EmeshInfo,EPHTelem,EcontrolPts,geometry)
...
[EPHTelem,EcontrolPts,EmeshInfo.dimBasis,EmeshInfo.quadList,EmarkRef] = checkConformingMark(EPHTelem,EcontrolPts,EmeshInfo.dimBasis,geometry.patchBoundaries,p,q,EmeshInfo.quadList,EmarkRef);
