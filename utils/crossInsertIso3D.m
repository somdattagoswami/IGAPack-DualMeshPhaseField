function [PHTelem,controlPts,dimBasis] = crossInsertIso3D(PHTelem,controlPts,elm_index,dimBasis,geometry)
...
for indexElem=1:length(elm_index)
    ...
    for ijunct = RTjunct
        ...
        %store the parent neighbors in a list to handle possible multiple
        %parents.
