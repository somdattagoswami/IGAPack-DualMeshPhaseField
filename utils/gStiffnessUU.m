function [stiffkUU,PhmarkRef,quadRef] = gStiffnessUU(EPHTelem,EmeshInfo,Ebasis,ETrans,PhPHTelem,Phidisp,Mater,geometry)
        ...
        if isempty(EPHTelem{indexPatch}(i).children)
            ...
            for ii=1:ngaussX
                for jj=1:ngaussY
                    ...
                    phigp = ETrans.shape{indexPatch}{i}(kgauss,:)*ephi;
